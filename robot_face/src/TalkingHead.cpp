...
TalkingHead::TalkingHead( QWidget* parent, std::string mesh_string, std::vector< std::vector<float> > material_vector ) :
    QWidget( parent ),
    phones_( 0 ),
    words_( 0 ),
    root_( 0 ),
...
{
    viseme_subscriber_ = node_handle.subscribe( "robot_face/festival_phonemes", 1, &TalkingHead::callbackVisemes, this );
    emotion_subscriber_ = node_handle.subscribe( "robot_face/text_out", 1, &TalkingHead::callbackTextForEmotion, this );
    talking_finished_subscriber_ = node_handle.subscribe( "robot_face/talking_finished", 1, &TalkingHead::callbackResetAnimation, this);
}
//---------------------------------------------------------------------------
