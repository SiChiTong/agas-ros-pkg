...
{
  int scaleBins = 1; // TODO Config::getInt( "ObjectRecognition.HoughClustering.iScaleBins" );
...
{
  int orientationBins = 1; // TODO Config::getInt( "ObjectRecognition.HoughClustering.iOrientationBins" );

  //turnAngle in radians (-PI to PI)
  
  if(turnAngle<-M_PI || turnAngle>M_PI)
  {
    // TRACE_ERROR("Orientation "<< turnAngle); // TODO use ros
  }
...
{
  int xLocationBins = 10; // TODO Config::getInt( "ObjectRecognition.HoughClustering.iXLocationBins" );
  int yLocationBins = 10; // TODO Config::getInt( "ObjectRecognition.HoughClustering.iYLocationBins" );
